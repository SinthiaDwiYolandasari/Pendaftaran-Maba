            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->usertype == 'admin')
                        ...
                        <x-nav-link href="{{ route('admin.pendaftaran') }}" :active="request()->routeIs('admin.pendaftaran')">
                            {{ __('Data Pendaftaran') }}
                    ...
                    @if (Auth::user()->usertype == 'user')
                        <x-nav-link href="{{ route('user.mahasiswa') }}" :active="request()->routeIs('user.mahasiswa')">
                            {{ __('Formulir Pendaftaran') }}
                        </x-nav-link>
                        <x-nav-link href="{{ route('user.pmb') }}" :active="request()->routeIs('user.pmb')">
